Console.Writeline ("Bitch de Moscow");
Console.Writeline ("Gotta let it go");
Console.Writeline ("Carinha de santo, coração é de gelo");
...
Console.Writeline ("Tô com-to com medo de me apaixonar yeah");
